...
import com.meluo.sdk.service.BeaconService;
import com.meluo.sdk.service.MonitoringResult;
import com.meluo.sdk.service.RangingResult;
import com.meluo.sdk.service.ScanPeriodData;
...
public class BeaconManager {
	...
	public boolean checkPermissionsAndService() {
		...
		int bluetoothAdminPermission = pm.checkPermission("android.permission.BLUETOOTH_ADMIN",
	...
	public void connect(ServiceReadyCallback callback) {
		...
		boolean bound = this.context.bindService(new Intent(this.context, BeaconService.class), this.serviceConnection,
				1);
	...
	public void disconnect() {
		...
		CopyOnWriteArraySet<String> tempRangedRegionIds = new CopyOnWriteArraySet<String>(this.rangedRegionIds);
		...
		CopyOnWriteArraySet<String> tempMonitoredRegionIds = new CopyOnWriteArraySet<String>(this.monitoredRegionIds);
