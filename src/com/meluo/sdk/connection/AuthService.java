	...
	public void processGattServices(List<BluetoothGattService> services) {
		...
		for (BluetoothGattService service : services) {
			if (EstimoteUuid.AUTH_SERVICE.equals(service.getUuid())) {
				this.characteristics.put(EstimoteUuid.AUTH_SEED_CHAR,
						service.getCharacteristic(EstimoteUuid.AUTH_SEED_CHAR));
				this.characteristics.put(EstimoteUuid.AUTH_VECTOR_CHAR,
						service.getCharacteristic(EstimoteUuid.AUTH_VECTOR_CHAR));
			}
		}
	}
