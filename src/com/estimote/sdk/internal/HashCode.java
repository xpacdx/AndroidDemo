...
public abstract class HashCode {
	...
	private static final class IntHashCode extends HashCode implements Serializable {
		...
		public byte[] asBytes() {
			...
			return new byte[] { (byte) this.hash, (byte) (this.hash >> 8), (byte) (this.hash >> 16),
					(byte) (this.hash >> 24) };
		}
	...
	private static final class LongHashCode extends HashCode implements Serializable {
		...
		public byte[] asBytes() {
			...
			return new byte[] { (byte) (int) this.hash, (byte) (int) (this.hash >> 8), (byte) (int) (this.hash >> 16),
					(byte) (int) (this.hash >> 24), (byte) (int) (this.hash >> 32), (byte) (int) (this.hash >> 40),
					(byte) (int) (this.hash >> 48), (byte) (int) (this.hash >> 56) };
		}
	...
	private static final class BytesHashCode extends HashCode implements Serializable {
		...
		public int asInt() {
			...
			return this.bytes[0] & 0xFF | (this.bytes[1] & 0xFF) << 8 | (this.bytes[2] & 0xFF) << 16
	...
	public static HashCode fromString(String string) {
		...
		Preconditions.checkArgument(string.length() % 2 == 0,
				"input string (%s) must have an even number of characters", new Object[] { string });
