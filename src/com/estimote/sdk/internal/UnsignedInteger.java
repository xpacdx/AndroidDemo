...
public final class UnsignedInteger extends Number {
	...
	public static UnsignedInteger valueOf(long value) {
		...
		Preconditions.checkArgument((value & 0xFFFFFFFF) == value,
				"value (%s) is outside the range for an unsigned integer value", new Object[] { Long.valueOf(value) });
	...
	public static UnsignedInteger valueOf(BigInteger value) {
		...
		Preconditions.checkArgument((value.signum() >= 0) && (value.bitLength() <= 32),
				"value (%s) is outside the range for an unsigned integer value", new Object[] { value });
	...
	public UnsignedInteger mod(UnsignedInteger val) {
		...
		return fromIntBits(UnsignedInts
				.remainder(this.value, ((UnsignedInteger) Preconditions.checkNotNull(val)).value));
	}
